...
#		if string.find(_OPTIONS["gcc"], "clang) and (str_to_version(_OPTIONS["gcc_version"]) < 80000 IN_LIST CPUS) OR BUILD_TOOLS)
#			defines {
#				"TARGET_OS_OSX=1
#			)
#		endif()
...
if(("8X300" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSPP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ARC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ARCOMPACT" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ARM" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ARM7" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SE3208" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("AMIS2000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ADSP21XX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ADSP21062" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("APEXC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSP16" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSP32C" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ASAP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("AM29000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("JAGUAR" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CUBEQCPU" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ES5510" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ESRIP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("E0C6200" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("COSMAC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("COPS1" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("COP400" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CP1610" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CCPU" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("T11" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PDP8" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("F8" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("FR" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("G65816" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("H16" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("H8" IN_LIST CPUS) OR BUILD_TOOLS)
	add_custom_command(
		COMMAND ${CMAKE_COMMAND} -E make_directory ${GEN_DIR}/emu/cpu/h8/
...
if(("H8500" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("HCD62121" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("HMCS40" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SH" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ST62XX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("HPHYBRID" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("NANOPROCESSOR" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CAPRICORN" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("H6280" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("E1" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("IE15" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MCS40" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("I8008" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SCMP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("I8085" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("I8089" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MCS48" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MCS51" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MCS96" IN_LIST CPUS) OR BUILD_TOOLS)
	add_custom_command(
		COMMAND ${CMAKE_COMMAND} -E make_directory ${GEN_DIR}/emu/cpu/mcs96/
...
if(("I86" IN_LIST CPUS) OR ("I386" IN_LIST CPUS) OR BUILD_TOOLS OR CPU_INCLUDE_DRC)
...
if(("I860" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("I960" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("LH5801" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SSEM" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DIABLO" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MB88XX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MB86233" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MB86235" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PIC16C5X" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PIC1670" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PIC16C62X" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PIC16" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PIC17" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MIPS1" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MIPS3" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PSX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MELPS4" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M23C" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M37710" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M6502" IN_LIST CPUS) OR BUILD_TOOLS)
	add_custom_command(
		COMMAND ${CMAKE_COMMAND} -E make_directory ${GEN_DIR}/emu/cpu/m6502/
...
if(("XAVIX" IN_LIST CPUS) OR BUILD_TOOLS)
	add_custom_command(
		COMMAND ${CMAKE_COMMAND} -E make_directory ${GEN_DIR}/emu/cpu/m6502/
...
if(("XAVIX2000" IN_LIST CPUS) OR BUILD_TOOLS)
	add_custom_command(
		COMMAND ${CMAKE_COMMAND} -E make_directory ${GEN_DIR}/emu/cpu/m6502/
...
if(("M6800" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M6805" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M6809" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MC68HC11" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M680X0" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSP56156" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PDP1" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PATINHOFEIO" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("POWERPC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("NEC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("V30MZ" IN_LIST CPUS) OR BUILD_TOOLS)
	list(APPEND DASM_SRCS ${MAME_DIR}/src/devices/cpu/nec/necdasm.cpp)
	list(APPEND DASM_SRCS ${MAME_DIR}/src/devices/cpu/nec/necdasm.h)
endif()
...
if(("V60" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("V810" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("V850" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UPD7725" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UPD7810" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UCOM4" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MINX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("RSP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MN1880" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MN10200" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SATURN" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SM510" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SM8500" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("S2650" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SC61860" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SPC700" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SSP1601" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UNSP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("AVR8" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS1000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS7000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS9900" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS340X0" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS32010" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS32025" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS32031" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS32051" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS32082" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TMS57002" IN_LIST CPUS) OR BUILD_TOOLS)	
...
if(("TLCS90" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TLCS870" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TLCS900" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("TX0" IN_LIST CPUS) OR BUILD_TOOLS)
...
if (("Z80" IN_LIST CPUS) OR ("KC80" IN_LIST CPUS) OR BUILD_TOOLS)
	list(APPEND CPU_SRCS
...
if(("LR35902" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("Z180" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("Z8000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("Z8" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SUPERFX" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PPS4" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PPS41" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("HD61700" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("LC8670" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SCUDSP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SCORE" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ALTO2" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("SPARC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CLIPPER" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("NUON" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ALPHA" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("HPC" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MEG" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSPV" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("NS32000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("RII" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("BCP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("F2MC16" IN_LIST CPUS) OR BUILD_TOOLS)
	list(APPEND DASM_SRCS ${MAME_DIR}/src/devices/cpu/f2mc16/f2mc16dasm.cpp)
	list(APPEND DASM_SRCS ${MAME_DIR}/src/devices/cpu/f2mc16/f2mc16dasm.h)
endif()
...
if(("CR16B" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("CR16C" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("GTRON" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("DSP56000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("VT50" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("VT61" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("PACE" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("WE32000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("RX01" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M88000" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("XAVIX2" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UPD78K" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("ROMP" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("KS0164" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("UPD177X" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("LC58" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MSM65X2" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("LC57" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("MK1" IN_LIST CPUS) OR BUILD_TOOLS)
...
if(("M68HC16" IN_LIST CPUS) OR BUILD_TOOLS)
